//! Quickstart example used by `docs/guide/src/quickstart-rust.md`.
//!
//! Loads ENDF resonance data for U-238, computes a theoretical transmission
//! spectrum, and fits it to recover the areal density. Compile-checked by
//! `cargo check --workspace --examples` so the mdBook page cannot drift out
//! of sync with the live crate APIs.
