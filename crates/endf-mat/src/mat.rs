...
// 259 entries from the CENDL-3.2 neutrons sublibrary, including free neutron.
// Format: (Z, A, MAT) — sorted by (Z, A). Re-run the regenerator if the
// upstream listing changes; do NOT edit by hand.
#[rustfmt::skip]
...
mod tests {
    ...
    fn test_mat_number_cendl_known_values() {
        ...
        // Free neutron — CENDL listing uses n_000-nn-1_0025.zip.
        assert_eq!(mat_number_cendl(0, 1), Some(25));
    }
    ...
    fn test_cendl_table_size() {
        assert_eq!(CENDL_3_2_MAT_TABLE.len(), 259);
    }
