...
| [`nereids-physics`](api/nereids_physics/) | Cross-section calculation (Reich-Moore, SLBW, MLBW), two-tier Doppler broadening (continuous / sampled-table, disclosed per isotope), resolution broadening, Beer-Lambert transmission |
